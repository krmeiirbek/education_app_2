  ...
  switch (settings.name) {
    ...
    case QuizVariantsScreen.routeName:
      return _pageBuilder(
        (_) => BlocProvider(
          ...
          child: QuizVariantsScreen(settings.arguments! as CourseModel),
        ),
        settings: settings,
      );
    case TestScreen.routeName:
      return _pageBuilder(
        (_) => BlocProvider(
          create: (_) => sl<QuizCubit>(),
          child: TestScreen(settings.arguments! as QuizModel),
        ),
        settings: settings,
      );
    case AddQuestionsSheet.routeName:
      return _pageBuilder(
        (_) => BlocProvider(
          create: (_) => sl<QuizCubit>(),
          child: AddQuestionsSheet(quiz: settings.arguments! as QuizModel),
        ),
        settings: settings,
      );
